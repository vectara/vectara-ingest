...
def run_crawler(cfg: DictConfig, env_dict: dict, profile_name: str, reset_corpus: bool = False) -> None:
    """Run the crawler with the given configuration and credentials."""
...
def run_ingest(config_file: str, profile: str, secrets_path: Optional[str] = None, reset_corpus: bool = False) -> None:
    ...
    logger.info(f'Using secrets from: {secrets_path}')
    ...
    # Run the crawler
    try:
        run_crawler(cfg, env_dict, profile, reset_corpus)
    except Exception as e:
