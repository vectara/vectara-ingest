...
class YtCrawler(Crawler):
    ...
    def crawl(self) -> None:
        ...
        try:
            ...
            logger.warning(f"Can't index description of playlist {playlist.title}, skipping")
        ...
        for video in videos_list:
            ...
            try:
                ...
                try:
                    ...
                    logger.error(f"Can't download video {video.title} with id {video.video_id}, e={e}")
                    continue
                ...
                logger.error(f"Can't process video {video.title} with id {video.video_id}, e={e}")
                continue
